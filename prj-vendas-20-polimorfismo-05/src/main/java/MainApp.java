...
public class MainApp  {
	public static void main(String[] args) {
		...
		//Exemplos de downcasting - atribuição de uma variável da superclasse sendo atribuída para uma variável do tipo da subclasse
		Nacional nacional = (Nacional) fornecedor; // Exceção - downcasting de um fornecedor Internacional para Nacional
		print(nacional);
		Internacional internacional = (Internacional) fornecedor; //Normal - downcasting de um fornecedor Internacional para Internacional
		print(internacional);
	}
